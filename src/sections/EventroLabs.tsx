...
import { Rocket, Palette, Zap, ArrowRight, Globe, Cpu, Sparkles } from 'lucide-react';

const services = [
  {
    icon: Palette,
    title: 'Landing Pages',
    description: 'High-converting, visually stunning landing pages that capture attention and drive results.',
    color: 'from-pink-500/20 to-rose-500/20',
  },
  {
    icon: Zap,
    title: 'AI Workflow Automation',
    description: 'Intelligent automation solutions using cutting-edge AI to streamline your business processes.',
    color: 'from-amber-500/20 to-yellow-500/20',
  },
  {
    icon: Globe,
    title: 'Web Applications',
    description: 'Full-stack web applications built with modern technologies for optimal performance.',
    color: 'from-blue-500/20 to-cyan-500/20',
  },
  {
    icon: Cpu,
    title: 'AI Integration',
    description: 'Seamless integration of AI capabilities like Gemini API into your existing systems.',
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`observe-reveal ${isVisible ? 'visible' : ''} mb-16`}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-red-500 text-sm font-medium tracking-wider uppercase">Currently Working On</span>
          </div>
        ...
        <div className={`observe-reveal ${isVisible ? 'visible' : ''} mb-12`} style={{ transitionDelay: '0.1s' }}>
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-3xl md:text-4xl font-bold text-white">Eventro Labs</h3>
                    <p className="text-red-400 font-medium">Design Agency & AI Solutions</p>
                  </div>
                </div>

                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  Eventro Labs is my design agency focused on creating exceptional digital experiences. 
                  We specialize in building high-converting landing pages and automating workflows using 
                  cutting-edge AI technologies like Gemini API.
                </p>

                <p className="text-gray-400 leading-relaxed mb-8">
                  From sleek, modern web designs to intelligent automation systems, we help businesses 
                  transform their digital presence and streamline operations with AI-powered solutions.
                </p>
        ...
        {/* CTA */}
        <div className={`observe-reveal ${isVisible ? 'visible' : ''} mt-12 text-center`} style={{ transitionDelay: '0.6s' }}>
